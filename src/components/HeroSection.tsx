  ...
  return (
    <section className="flex flex-col items-center justify-center px-4 pt-12 pb-8 text-center">
      <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-[#1a1a1a] py-2 text-sm px-2">
        <span className="rounded-full bg-violet-500/20 px-2 py-0.5 text-xs font-medium text-violet-400">FREEMIUM</span>
        <span className="text-gray-300">Старт бесплатно — прокачивайся по мере роста</span>
        <ArrowUpRight className="h-4 w-4 text-gray-400" />
      </div>

      <h1 className="mb-4 max-w-3xl text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-white text-balance">
        Управляй финансами со свободой LinkUp
      </h1>

      <p className="mb-8 max-w-xl text-gray-400">Счета, переводы и контроль расходов в одном приложении. Начни бесплатно, открой Premium, когда будешь готов.</p>
